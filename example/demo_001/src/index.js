...
async function main() {
    ...
    const dataSource = application.getContainer().get("DataSource")?.funcInstance;
    ...
    router.get("/openapi", (req, res) => {
        ...
        res.send(YAML.stringify(generateOpenAPIObject(usecases.map((x) => x.funcMetadata), securitySchema)));
    });
